const translations = {
  es: {
    ...
    "Advanced React E-commerce": "E-commerce Avanzado con React",
    "Advanced React E-commerce Intro": "🛍️ Una plataforma de comercio electrónico robusta y escalable construida con React, Redux Toolkit, Firebase y TypeScript, diseñada para ofrecer una experiencia de compra fluida desde la navegación hasta el pago.",
    "Advanced React E-commerce Auth": "🔐 Autenticación: Registro/inicio de sesión seguro con Firebase Authentication y manejo de sesiones mediante Redux Toolkit.",
    "Advanced React E-commerce User": "👤 Gestión de Usuarios: Edición y eliminación de perfiles de usuario, sincronizados en tiempo real con Firestore.",
    "Advanced React E-commerce Cart": "🛒 Carrito Inteligente: Carrito interactivo con gestión dinámica de cantidades, actualizaciones de artículos y funcionalidad de pago mediante Firestore.",
    "Advanced React E-commerce Products": "📦 Productos y Control Administrativo: Productos obtenidos desde Firestore, con funciones de administrador para operaciones CRUD e importación automática desde FakeStoreAPI.",
    "Advanced React E-commerce Orders": "🧾 Historial de Pedidos: Los usuarios pueden revisar pedidos anteriores con listas de productos, totales y fechas de compra—ofreciendo transparencia y profesionalismo.",
    "Advanced React E-commerce Tech": "🛠️ Stack Tecnológico: React, Redux Toolkit, Firebase (Auth + Firestore), React Router, TypeScript, React Toastify.",
    "Advanced React E-commerce Tests": "🧪 Pruebas: Pruebas unitarias e integradas usando Jest y React Testing Library, siguiendo principios de desarrollo guiado por pruebas (TDD).",
    "Advanced React E-commerce CI": "🔄 CI/CD: Integración continua con GitHub Actions—ejecutando compilación, verificación de tipos y pruebas antes del despliegue automático en Vercel.",
    "Advanced React E-commerce Coverage": "📊 Cobertura: Soporte de cobertura con Jest para asegurar calidad local y seguimiento de métricas.",
    "Link to the live app": "📌 Ver en vivo:",
    ...
    "EPUB Page Editor": "Editor de Páginas EPUB",
    "EPUB Tool Intro": "📖 Aplicación de escritorio para la edición precisa de archivos EPUB—permite modificar páginas `.xhtml`, reordenar el spine, revisar metadatos y limpiar recursos sin afectar la estructura del archivo.",
    "EPUB Tool Core": "🛠️ Funciones Clave: Desempaquetado automático de EPUB (`zipfile`, `shutil`), análisis y validación del spine (`lxml`), vista previa de páginas en tiempo real, eliminación individual o en lote de archivos `.xhtml`, sincronización del spine y manifest, y reempaquetado del EPUB con integridad CRC.",
    "EPUB Tool Model": "🔍 Control Estructurado de EPUB: Muestra archivos, metadatos (título, identificador, portada) y cuenta de archivos; maneja EPUBs dañados con cargadores alternativos; registra operaciones internas y preserva la estructura EPUB 2.0/3.0.",
  ...
  fr: {
    ...
    "Advanced React E-commerce": "E-commerce Avancé avec React",
    "Advanced React E-commerce Intro": "🛍️ Une plateforme e-commerce robuste et évolutive développée avec React, Redux Toolkit, Firebase et TypeScript—offrant une expérience d'achat fluide de la navigation au paiement.",
    "Advanced React E-commerce Auth": "🔐 Authentification : Inscription/connexion sécurisée via Firebase Authentication et gestion des sessions avec Redux Toolkit.",
    "Advanced React E-commerce User": "👤 Gestion des Utilisateurs : Modification et suppression du profil utilisateur, synchronisées en temps réel avec Firestore.",
    "Advanced React E-commerce Cart": "🛒 Panier Intelligent : Panier interactif avec gestion dynamique des quantités, mises à jour des articles et paiement via Firestore.",
    "Advanced React E-commerce Products": "📦 Produits & Administration : Produits récupérés depuis Firestore, avec fonctions admin pour les opérations CRUD et importation automatique depuis FakeStoreAPI.",
    "Advanced React E-commerce Orders": "🧾 Historique des Commandes : Les utilisateurs peuvent consulter les commandes passées, y compris les produits, montants et dates—pour une transparence professionnelle.",
    ...
    "Advanced React E-commerce Tests": "🧪 Tests : Tests unitaires et d'intégration réalisés avec Jest et React Testing Library, selon les principes du TDD.",
    "Advanced React E-commerce CI": "🔄 CI/CD : Intégration continue via GitHub Actions—build, vérifications de type et tests avant déploiement automatique sur Vercel.",
    "Advanced React E-commerce Coverage": "📊 Couverture : Couverture de tests avec Jest pour l'assurance qualité locale et le suivi des métriques.",
    "Link to the live app": "📌 Voir en ligne:",
    "Task Manager App": "Task Manager App",
    ...
    "Task Manager App Tech": "🛠️ Stack : React + Vite, TypeScript, Auth0, Context API, React Router, React Big Calendar.",
    "EPUB Page Editor": "Éditeur de Pages EPUB",
    "EPUB Tool Intro": "📖 Application de bureau pour l’édition fine des fichiers EPUB—permet la modification non destructive des pages `.xhtml`, le réagencement du spine, l’examen des métadonnées et le nettoyage des ressources.",
    "EPUB Tool Core": "🛠️ Fonctionnalités Principales : Extraction automatique de fichiers EPUB (`zipfile`, `shutil`), analyse et validation du spine (`lxml`), aperçu des pages en temps réel, suppression individuelle ou par lot de fichiers `.xhtml`, synchronisation du spine et du manifest, et recompression EPUB avec vérification CRC.",
    "EPUB Tool Model": "🔍 Contrôle Structuré EPUB : Affiche tous les fichiers, métadonnées (titre, identifiant, couverture) et le nombre de fichiers; gère les EPUBs corrompus avec des chargeurs de secours; enregistre les opérations internes; conserve la structure EPUB 2.0/3.0.",
  ...
  it: {
    ...
    "Advanced React E-commerce": "E-commerce Avanzato con React",
    "Advanced React E-commerce Intro": "🛍️ Una piattaforma di e-commerce robusta e scalabile sviluppata con React, Redux Toolkit, Firebase e TypeScript—pensata per offrire un'esperienza di acquisto fluida dalla navigazione al checkout.",
    "Advanced React E-commerce Auth": "🔐 Autenticazione: Registrazione/login sicuro tramite Firebase Authentication e gestione sessioni con Redux Toolkit.",
    "Advanced React E-commerce User": "👤 Gestione Utente: Modifica e cancellazione profili utente, sincronizzati in tempo reale con Firestore.",
    "Advanced React E-commerce Cart": "🛒 Carrello Intelligente: Carrello interattivo con gestione dinamica delle quantità, aggiornamenti articoli e checkout su Firestore.",
    "Advanced React E-commerce Products": "📦 Prodotti & Amministrazione: Prodotti caricati da Firestore, con funzionalità admin per operazioni CRUD e importazione automatica da FakeStoreAPI.",
    "Advanced React E-commerce Orders": "🧾 Storico Ordini: Gli utenti possono rivedere gli ordini precedenti con lista prodotti, totale e data d'acquisto—per un tocco di professionalità.",
    ...
    "Advanced React E-commerce Tests": "🧪 Test: Test unitari e d'integrazione realizzati con Jest e React Testing Library secondo i principi del TDD.",
    "Advanced React E-commerce CI": "🔄 CI/CD: Integrazione continua tramite GitHub Actions—build, controllo tipi e test prima del deploy automatico su Vercel.",
    "Advanced React E-commerce Coverage": "📊 Copertura: Copertura test con Jest per assicurare qualità locale e monitoraggio delle metriche.",
    "Link to the live app": "📌 Guarda online:",
    "Task Manager App": "Task Manager App",
